...
china12 <- atheism %>% filter(nationality == "China", year == 2012)
inference(y = response, data = china12, type = "ci", statistic = "proportion",
          method = "theoretical", success = "atheist")

jp12 <- atheism %>% filter(nationality == "Japan", year == 2012)
inference(y = response, data = jp12, type = "ci", statistic = "proportion", 
          method = "theoretical", success = "atheist")
```
...
inference(y = response, x = year, data = spain, type = "ci", statistic = "proportion",
          method = "theoretical", success = "atheist")
```
...
inference(y = response, x = as.factor(year), data = us, type = "ci",
          statistic = "proportion", method = "theoretical", success = "atheist")
```
...
jp <- atheism %>% filter(nationality == "Japan")
inference(y = response, x = as.factor(year), data = jp, type = "ci",
          statistic = "proportion", method = "theoretical", success = "atheist")
```
