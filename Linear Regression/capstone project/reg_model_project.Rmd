...
## Part 1: Data
The data contains 651 randomly sampled movies released before 2016. So study based on the data would has generablizability. However, movies are rated by volunteers, so the data may contain volunteer bais. Data is not generated from experiment, it could only be used in oberservational study. So causality can not found from the data.
...
## Part 5: Prediction
Recently, I just watch a very good animation "train to busan". I want to predict the rating of it.
