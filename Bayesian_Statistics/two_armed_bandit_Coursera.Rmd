...
```{r}
bandit_posterior(data.frame(machine = c(1L, 1L, 2L, 2L, 2L), outcome = c("W", "W", "W", "W", "L")))
```
...
```{r}
bandit_posterior(data.frame(machine = c(2L, 2L, 2L, 1L, 1L), outcome = c("W", "W", "L", "W", "W")))
```
...
```{r}
data = data.frame(machine = c(1L, 1L, 2L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L), outcome = c("L", "W", "L", "W", "W", "W", "W", "W", "L", "W", "W", "W", "L", "L", "W", "L", "L", "L", "W", "L", "W", "L", "W", "L", "L", "W", "L", "W", "L", "L", "L", "W", "L", "L", "L", "W", "L", "L", "L", "L", "L", "W", "W", "L", "L", "W", "L", "W", "W", "W"))
plot_bandit_posterior(data)
```
